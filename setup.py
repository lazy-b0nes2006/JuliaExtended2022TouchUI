...
plugin_identifier = "JuliaExtended2022TouchUI"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_JuliaExtended2022TouchUI"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Octoprint-JuliaExtended2022TouchUI"
...
# module
plugin_description = """TouchScreen Plugin for Julia Extended ABL based on Python3 and PyQt5"""
...
plugin_url = "https://github.com/FracktalWorks/JuliaExtended2022TouchUI"
